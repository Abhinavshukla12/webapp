...
<div class="container">
        ...
        <div class="mainPage">
            ...
            <img src="<?= base_url('assets/img/m3.png') ?>" alt="">
        </div>
        ...
        <div class="cardMen">
            ...
            <div class="card" id="item1">
                <div class="crd">
                    <img src="<?= base_url('assets/img/srt1.webp') ?>" alt="" onclick="showCard(this)">
                    <div class="txt">
                ...
                <div class="crd">
                    <img src="<?= base_url('assets/img/srt2.webp') ?>" alt="" onclick="showCard(this)">
                    <div class="txt">
                        <h3>Cutton Shirt's</h3>
                        <i class="fa-solid fa-star"></i>
                        <i class="fa-solid fa-star"></i>
                ...
                <div class="crd">
                    <img src="<?= base_url('assets/img/srt6.webp') ?>" alt="" onclick="showCard(this)">
                    <div class="txt">
                        <h3>Cutton Shirt's</h3>
                        <i class="fa-solid fa-star"></i>
                        <i class="fa-solid fa-star"></i>
        ...
        <div class="cardgirl">
            ...
            <div class="card">
                <div class="crd">
                    <img src="<?= base_url('assets/img/wn4.webp') ?>" alt="" onclick="showCard(this) ">
                    <div class="txt">
                        <h3>Girl Tops</h3>
                        <i class="fa-solid fa-star"></i>
                        <i class="fa-solid fa-star"></i>
                ...
                <div class="crd">
                    <img src="<?= base_url('assets/img/wn5.webp') ?>" alt="" onclick="showCard(this) ">
                    <div class="txt">
                        <h3>Girl Tops</h3>
                        <i class="fa-solid fa-star"></i>
                        <i class="fa-solid fa-star"></i>
                ...
                <div class="crd">
                    <img src="<?= base_url('assets/img/wn6.webp') ?>" alt="" onclick="showCard(this)">
                    <div class="txt">
                        <h3>Girl Tops</h3>
                        <i class="fa-solid fa-star"></i>
                        <i class="fa-solid fa-star"></i>
        ...
        <div class="blogContent">
            ...
            <div class="trd">
                <div class="trending">
                    <img src="<?= base_url('assets/img/tr1.webp') ?>" alt="">
                    <div class="txt">
                ...
                <div class="trending">
                    <img src="<?= base_url('assets/img/tr3.webp') ?>" alt="">
                    <div class="txt">
        ...
        <div class="about">
            ...
            <div class="aboutus">
                <img src="<?= base_url('assets/img/lap.png') ?>" alt="">
                <div class="dumiText">
                    <h1>Who we are ?</h1>
